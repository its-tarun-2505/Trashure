...
const requestSchema = new Schema(
  {
    ...
    images: [{ type: String }], 
    status: { type: String, enum: ['pending', 'accepted', 'on-the-way', 'collected', 'pending-completion', 'completed', 'cancelled'], default: 'pending' },
    notes: { type: String },
    weight: { type: Number }, // in kg
    volume: { type: Number }, // in cubic meters
    proofImages: [{ type: String }], // Images uploaded by collector as proof of work
