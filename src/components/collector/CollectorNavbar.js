...
const CollectorNavbar = () => {
  ...
  const notifications = [
    // { id: 1, message: 'New collection request from John Doe', time: '2 min ago', unread: true },
    // { id: 2, message: 'Collection completed for Area A', time: '1 hour ago', unread: true },
    ...
    <nav className={styles.navbar}>
      <div className={styles.container}>
        ...
        <div className={styles.brand}>
          <Link href="/collector/dashboard" className={styles.logoLink}>
            <div className={styles.logo}>
              ...
              <span className={styles.brandName}>Trashure</span>
            </div>
          </Link>
        </div>
              ...
              <div className={styles.profileDropdown}>
                <div className={styles.profileInfo}>
                  <div className={styles.profileImageLarge}>
                    <div className={styles.profileInitialsLarge}>
                      {userData?.name ? userData.name.charAt(0).toUpperCase() : 'U'}
                    </div>
                  </div>
                  <div className={styles.profileDetails}>
                    <h4>{userData?.name || 'Collector'}</h4>
                    <p>{userData?.email || 'collector@example.com'}</p>
                  </div>
                </div>
